package com.hmelizarraraz.backgrounddownload;
...
public class BackgroundNotificationService extends IntentService {
    ...
    private void updateNotification(int currentProgress) {
        ...
        notificationBuilder.setContentText("Descargado: " + currentProgress + "%");
        notificationManager.notify(0, notificationBuilder.build());
    }
    ...
    private void onDownloadComplete(boolean downloadComplete) {
        ...
        notificationBuilder.setContentText("Imagen descargada completamente");
        notificationManager.notify(0, notificationBuilder.build());
    }
